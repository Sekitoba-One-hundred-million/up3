...
class OnceData:
    ...
    def create( self, race_id, odds_index ):
        ...
        for horce_id in self.race_horce_data.horce_id_list:
            ...
            current_race_data[data_name.speed_index].append( max( lib.max_check( speed ) + current_time_index["max"], \
                                                                 lib.escapeValue ) )
            ...
            current_race_data[data_name.max_up3_time_point].append( pd.max_up3TimePoint( getHorceData.key_limb ) )
